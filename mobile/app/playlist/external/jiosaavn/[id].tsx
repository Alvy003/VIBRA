...
import { ChevronLeft, Play, Pause, ListMusic, Clock, Music, Star, MoreVertical } from 'lucide-react-native';
        ...
        <View className="flex-1 bg-zinc-950">
            ...
            >
                ...
                <View className="relative h-80">
                    ...
                    />
                    <LinearGradient
                        colors={['rgba(0,0,0,0.3)', 'rgba(0,0,0,0.6)', 'rgb(9, 9, 11)']}
                    ...
                    <View className="absolute bottom-6 left-6 right-6">
                        <View className="flex-row items-end space-x-4">
                            ...
                            <View className="flex-1 pb-1">
                                <Text className="text-pink-400 text-xs font-bold uppercase tracking-widest mb-1">Playlist</Text>
                                <Text className="text-white text-2xl font-bold mb-1" numberOfLines={2}>{playlist.title}</Text>
                                <Text className="text-zinc-400 text-sm font-medium line-clamp-1" numberOfLines={1}>{playlist.description || 'Curated for you'}</Text>
                            </View>
                        </View>
                    </View>
                </View>
                ...
                <View className="px-6 py-6 flex-row items-center justify-between">
                    <View className="flex-row items-center space-x-4">
                        ...
                        <View>
                            <Text className="text-zinc-500 text-xs font-bold uppercase">{playlist.songs?.length || 0} Tracks</Text>
                            <Text className="text-zinc-300 text-xs">JioSaavn External</Text>
                        </View>
                    </View>
                    ...
                    {playlist.songs?.map((song: any, index: number) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Image
                                    source={{ uri: song.imageUrl || playlist.imageUrl }}
